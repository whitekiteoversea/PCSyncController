...
public:
    ...
    QLabel *label_26;
    QLabel *PMSM1Posi;
    QLabel *PMSM1TargetPosi;
    QLabel *label_27;
    QLabel *PMSM2Posi;
    QLabel *PMSM2TargetPosi;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        speedRecord->setObjectName(QString::fromUtf8("speedRecord"));
        ...
        groupBox_8->setGeometry(QRect(800, 230, 351, 261));
        ...
        DualMotorPosi = new QCheckBox(groupBox_8);
        DualMotorPosi->setObjectName(QString::fromUtf8("DualMotorPosi"));

        gridLayout_5->addWidget(DualMotorPosi, 0, 1, 1, 2);

        refPosiSig = new QLineEdit(groupBox_8);
        refPosiSig->setObjectName(QString::fromUtf8("refPosiSig"));

        gridLayout_5->addWidget(refPosiSig, 1, 1, 1, 2);
        ...
        PMSM1Posi = new QLabel(groupBox_8);
        PMSM1Posi->setObjectName(QString::fromUtf8("PMSM1Posi"));
        PMSM1Posi->setAlignment(Qt::AlignCenter);

        gridLayout_5->addWidget(PMSM1Posi, 2, 1, 1, 1);

        PMSM1TargetPosi = new QLabel(groupBox_8);
        PMSM1TargetPosi->setObjectName(QString::fromUtf8("PMSM1TargetPosi"));
        PMSM1TargetPosi->setAlignment(Qt::AlignCenter);

        gridLayout_5->addWidget(PMSM1TargetPosi, 2, 2, 1, 1);
        ...
        PMSM2Posi = new QLabel(groupBox_8);
        PMSM2Posi->setObjectName(QString::fromUtf8("PMSM2Posi"));
        PMSM2Posi->setAlignment(Qt::AlignCenter);

        gridLayout_5->addWidget(PMSM2Posi, 3, 1, 1, 1);

        PMSM2TargetPosi = new QLabel(groupBox_8);
        PMSM2TargetPosi->setObjectName(QString::fromUtf8("PMSM2TargetPosi"));
        PMSM2TargetPosi->setAlignment(Qt::AlignCenter);

        gridLayout_5->addWidget(PMSM2TargetPosi, 3, 2, 1, 1);

        PosiLoopSyncInit = new QPushButton(groupBox_8);
        PosiLoopSyncInit->setObjectName(QString::fromUtf8("PosiLoopSyncInit"));

        gridLayout_5->addWidget(PosiLoopSyncInit, 4, 0, 1, 1);

        PosiLoopInit_2 = new QPushButton(groupBox_8);
        PosiLoopInit_2->setObjectName(QString::fromUtf8("PosiLoopInit_2"));

        gridLayout_5->addWidget(PosiLoopInit_2, 4, 1, 1, 2);
        ...
        gridLayout_5->addWidget(label_28, 5, 1, 1, 2);

        torque1 = new QLabel(groupBox_8);
        torque1->setObjectName(QString::fromUtf8("torque1"));

        gridLayout_5->addWidget(torque1, 6, 0, 1, 1);

        torque2 = new QLabel(groupBox_8);
        torque2->setObjectName(QString::fromUtf8("torque2"));

        gridLayout_5->addWidget(torque2, 6, 1, 1, 1);

        label_24 = new QLabel(groupBox_8);
        label_24->setObjectName(QString::fromUtf8("label_24"));

        gridLayout_5->addWidget(label_24, 0, 0, 2, 1);
        ...
        ETHMode->setObjectName(QString::fromUtf8("ETHMode"));
        ...
        modeSet1->addItem(QString());
        modeSet1->addItem(QString());
        modeSet1->setObjectName(QString::fromUtf8("modeSet1"));
        modeSet1->setEditable(false);

        verticalLayout_2->addWidget(modeSet1);

        PMSM1workModeSetup = new QPushButton(groupBox_9);
        PMSM1workModeSetup->setObjectName(QString::fromUtf8("PMSM1workModeSetup"));
        ...
        modeSet2->addItem(QString());
        modeSet2->addItem(QString());
        modeSet2->setObjectName(QString::fromUtf8("modeSet2"));

        verticalLayout_2->addWidget(modeSet2);

        PMSM2workModeSetup = new QPushButton(groupBox_9);
        PMSM2workModeSetup->setObjectName(QString::fromUtf8("PMSM2workModeSetup"));
        ...
        layoutWidget5->setGeometry(QRect(12, 30, 181, 231));
        gridLayout_3 = new QGridLayout(layoutWidget5);
        gridLayout_3->setObjectName(QString::fromUtf8("gridLayout_3"));
        gridLayout_3->setContentsMargins(0, 0, 0, 0);
        verticalLayout_3 = new QVBoxLayout();
        verticalLayout_3->setObjectName(QString::fromUtf8("verticalLayout_3"));
        label_33 = new QLabel(layoutWidget5);
        label_33->setObjectName(QString::fromUtf8("label_33"));

        verticalLayout_3->addWidget(label_33);

        PMSM1STA = new QLabel(layoutWidget5);
        PMSM1STA->setObjectName(QString::fromUtf8("PMSM1STA"));
        ...
        posiSyncError = new QLabel(layoutWidget5);
        posiSyncError->setObjectName(QString::fromUtf8("posiSyncError"));
        ...
        rotateAngle = new QLabel(layoutWidget5);
        ...
        PMSM1OM = new QLabel(layoutWidget5);
        PMSM1OM->setObjectName(QString::fromUtf8("PMSM1OM"));
        ...
        PMSM2STA = new QLabel(layoutWidget5);
        PMSM2STA->setObjectName(QString::fromUtf8("PMSM2STA"));
        ...
        PMSM2OM = new QLabel(layoutWidget5);
        PMSM2OM->setObjectName(QString::fromUtf8("PMSM2OM"));
        ...
        layoutWidget6->setGeometry(QRect(800, 20, 351, 191));
        horizontalLayout = new QHBoxLayout(layoutWidget6);
        horizontalLayout->setObjectName(QString::fromUtf8("horizontalLayout"));
        horizontalLayout->setContentsMargins(0, 0, 0, 0);
        groupBox_7 = new QGroupBox(layoutWidget6);
        ...
        readCAS->setObjectName(QString::fromUtf8("readCAS"));
        ...
        CASUploadStatus->setObjectName(QString::fromUtf8("CASUploadStatus"));
        ...
        groupBox_11 = new QGroupBox(layoutWidget6);
        ...
        layoutWidget7->setGeometry(QRect(12, 30, 111, 141));
        verticalLayout_8 = new QVBoxLayout(layoutWidget7);
        verticalLayout_8->setObjectName(QString::fromUtf8("verticalLayout_8"));
        verticalLayout_8->setContentsMargins(0, 0, 0, 0);
        readFile = new QPushButton(layoutWidget7);
        ...
        StorePMSM1 = new QPushButton(layoutWidget7);
        StorePMSM1->setObjectName(QString::fromUtf8("StorePMSM1"));
        ...
        StorePMSM2 = new QPushButton(layoutWidget7);
        StorePMSM2->setObjectName(QString::fromUtf8("StorePMSM2"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_3->setText(QCoreApplication::translate("MainWindow", "\347\273\231\345\256\232:0.1rpm/0.001Nm\357\274\232", nullptr));
        ...
        PMSM1TargetPosi->setText(QCoreApplication::translate("MainWindow", "0", nullptr));
        ...
        PMSM2TargetPosi->setText(QCoreApplication::translate("MainWindow", "0", nullptr));
        ...
        label_24->setText(QCoreApplication::translate("MainWindow", "\347\273\231\345\256\232\344\275\215\347\247\273\345\242\236\351\207\217/\347\273\235\345\257\271\345\220\214\346\255\245\344\275\215\347\275\256(um)", nullptr));
